...
NDiplomacy = {
	...
	MAX_DUCHIES_LEGALLY_HELD = 1,				-- Max duchies that a king or above can hold before vassals start getting angry
...
NCharacter = {
	...
	AGE_OF_MARRIAGE_MALE = 18,						-- Male allowed to marry at this age.
	AGE_OF_MARRIAGE_FEMALE = 18,					-- Female allowed to marry at this age.
	...
	NATURAL_DEATH_CHANCE_AGE_50 = 205,				-- Natural deaths per decade out of 10000 people: Age 50-59
	NATURAL_DEATH_CHANCE_AGE_60 = 510,				-- Natural deaths per decade out of 10000 people: Age 60-69
	NATURAL_DEATH_CHANCE_AGE_70 = 1020,				-- Natural deaths per decade out of 10000 people: Age 70-79
...
-- Title Grant Decadence Reduction (Multiplied with current decadence)
	...
	DE_JURE_ASSIMILATION_YEARS = 25,			-- Duchies a under the de facto control of another kingdom will change de jure liege after this many years
	...
	MAX_REPUBLIC_COUNTIES_IN_REALM = 1,		-- 10% of a feudal realm is allowed to be under vassal republics (affects title grants)
	MAX_THEOCRACY_COUNTIES_IN_REALM = 1,		-- 10% of a feudal realm is allowed to be under vassal theocracies/bishoprics (affects title grants)
...
-- Title creation and usurpation requirements	
	DEJURE_COUNTY_LIMIT_TO_CREATE = 0.50,			-- Fraction of de jure counties that you must control to create a non-imperial title
...
NMilitary = {
	...
	ARMY_UNLOAD_MOVE_COST = 20.0,				-- Movement cost for moving armies onto or off fleets at sea.
	...
	RETINUE_FROM_REALMSIZE = 0.0,					-- Retinues should be based exclusively on castle buildings
	...
	LIGHT_INFANTRY_PHASE_MELEE_DEFENSE = 20,
	...
	HEAVY_INFANTRY_PHASE_MELEE_DEFENSE = 20,
	...
	LIGHT_CAVALRY_PHASE_SKIRMISH_DEFENSE = 50,
	LIGHT_CAVALRY_PHASE_MELEE_DEFENSE = 5,
	LIGHT_CAVALRY_PHASE_PURSUE_DEFENSE = 5,
	LIGHT_CAVALRY_GRAPHICAL_FACTOR = 1,
	
	KNIGHTS_MORALE = 45,
	KNIGHTS_MAINTENANCE = 10,
	KNIGHTS_PHASE_SKIRMISH_ATTACK = 0.5,
	KNIGHTS_PHASE_MELEE_ATTACK = 10,
	KNIGHTS_PHASE_PURSUE_ATTACK = 8,
	KNIGHTS_PHASE_SKIRMISH_DEFENSE = 80,
	KNIGHTS_PHASE_MELEE_DEFENSE = 10,
	KNIGHTS_PHASE_PURSUE_DEFENSE = 20,
	...
	ARCHERS_PHASE_PURSUE_ATTACK = 15,
	ARCHERS_PHASE_SKIRMISH_DEFENSE = 3,
	ARCHERS_PHASE_MELEE_DEFENSE = 2,
	ARCHERS_PHASE_PURSUE_DEFENSE = 3,
	ARCHERS_GRAPHICAL_FACTOR = 1,
	
	SPECIAL_TROOPS_MORALE = 80,
	SPECIAL_TROOPS_MAINTENANCE = 8,
	SPECIAL_TROOPS_PHASE_SKIRMISH_ATTACK = .5,
	SPECIAL_TROOPS_PHASE_MELEE_ATTACK = 12,
	SPECIAL_TROOPS_PHASE_PURSUE_ATTACK = 15,
	SPECIAL_TROOPS_PHASE_SKIRMISH_DEFENSE = 10,
	SPECIAL_TROOPS_PHASE_MELEE_DEFENSE = 15,
	SPECIAL_TROOPS_PHASE_PURSUE_DEFENSE = 15,
	SPECIAL_TROOPS_GRAPHICAL_FACTOR = 1.5,
